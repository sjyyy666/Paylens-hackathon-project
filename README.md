...
Which risk engine is called by src.services.

Whether contract_model.py is used by the application.

Whether the parameter name and probability meaning are consistent across all modules.

Whether the displayed customer-risk score increases when the delay probability increases.

Whether the simulator recalculates the same engine used for the main deal analysis.
